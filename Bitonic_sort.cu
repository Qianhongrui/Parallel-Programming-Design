...
#define NUM_VALS ((unsigned long int)THREADS*BLOCKS*128*4)
...
int main(void)
{
  ...
  int *values1;// = (int*) malloc( NUM_VALS * sizeof(int));
  int *values2;// = (int*) malloc( NUM_VALS * sizeof(int)/2);
  int *sum1 = (int*) malloc( NUM_VALS * sizeof(int)*2);
  //int *sum2 = (int*) malloc( NUM_VALS * sizeof(int)*2.5);
  cudaMallocManaged( (void**)&values, NUM_VALS * sizeof(int)) ;
  cudaMallocManaged( (void**)&values1, NUM_VALS * sizeof(int)) ;
  cudaMallocManaged( (void**)&values2, NUM_VALS * sizeof(int)/2) ;
  /*cudaMallocManaged( (void**)&sum1, NUM_VALS * sizeof(int)*2) ;
  cudaMallocManaged( (void**)&sum2, NUM_VALS * sizeof(int)*2.5) ;*/
  start = clock();
